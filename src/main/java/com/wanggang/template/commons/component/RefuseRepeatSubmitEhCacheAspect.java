...
import com.wanggang.template.commons.utils.cache.ehcache.EhCacheUtils;
...
public class RefuseRepeatSubmitEhCacheAspect {
    ...
    @Pointcut(value = "@annotation(com.wanggang.template.commons.annotation.RefuseRepeatEhCacheSubmit)")
