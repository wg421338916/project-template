...
import com.wanggang.template.commons.constants.SecurityLoginConstants;
import com.wanggang.template.commons.filters.LoginFilter;
import com.wanggang.template.commons.interceptor.handler.CustomerAccessDeniedHandler;
import com.wanggang.template.commons.interceptor.handler.CustomerAuthLoginFailureHandler;
import com.wanggang.template.commons.interceptor.handler.CustomerAuthLoginSuccessHandler;
import com.wanggang.template.commons.interceptor.handler.CustomerAuthNoLoginHandler;
import com.wanggang.template.commons.interceptor.provider.CaptchaAuthenticationProvider;
import com.wanggang.template.commons.interceptor.provider.EmailAuthenticationProvider;
import com.wanggang.template.commons.interceptor.provider.LogAuthenticationProvider;
import com.wanggang.template.commons.interceptor.provider.SmsCodeAuthenticationProvider;
...
public class CustomerWebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private Filter getFilter() throws Exception {
        ...
        AbstractRememberMeServices tokenBasedRememberMeServices = new PersistentTokenBasedRememberMeServices("wanggang-session", userDetailsService, tokenRepository);
