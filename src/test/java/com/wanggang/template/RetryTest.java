...
import com.wanggang.template.commons.utils.retry.*;
...
public class RetryTest {
    ...
    public void jsonTest() {
        ...
        byte[] bytes = "[\"com.wanggang.template.RetryTest$UserTest\",{\"name1\":null,\"now\":[2020,11,12,14,42,36,664000000],\"now2\":[\"java.util.Date\",1605163357055],\"name\":\"demo\"}]".getBytes();
        UserTest deserialize = serializer.deserialize(bytes, new TypeReference<UserTest>() {
        });

        byte[] bytes2 = "[\"com.wanggang.template.RetryTest$UserTest\",{\"name\":\"demo\"}]".getBytes();
